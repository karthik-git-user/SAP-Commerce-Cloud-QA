 ...
 */
@Controller
public class NovalnetMerchantCallbackController extends BaseIntegrationController
{
	private static final Logger LOG = Logger.getLogger(NovalnetMerchantCallbackController.class);
	...
	public void processPost(final HttpServletRequest request, final HttpServletResponse response)
	{
		...
		System.out.println(TOKEN_EMPTY1);
		System.out.println("============================== print ==================================");
