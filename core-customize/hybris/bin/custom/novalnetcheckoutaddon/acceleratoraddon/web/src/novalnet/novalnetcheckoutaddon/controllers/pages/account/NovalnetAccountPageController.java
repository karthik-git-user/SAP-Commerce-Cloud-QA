    ...
    public String order(@PathVariable("orderCode") final String orderCode, final Model model,
        ...
        try {
            ...
            if (paymentInfo != null && !paymentInfo.isEmpty()) {
                ...
                novalnetPaymentData.setTransactionDetails(paymentInfo.get(0).getPaymentInfo().toString());
                novalnetPaymentData.setOrderHistoryNotes(paymentInfo.get(0).getOrderHistoryNotes().toString());
